...
torchrun --nproc_per_node=4 --master_port 17999 train.py \
    ...
    --output_dir /inspire/ssd/ws-f4d69b29-e0a5-44e6-bd92-acf4de9990f0/public-project/tangbohao-240108100043/bohao_mimic_project/SFT/results/trail_1 \
    --bf16 True \
