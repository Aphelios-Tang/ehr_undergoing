...
torchrun --nproc_per_node=2 --master_port 17999 train_from_freetext_addcompress.py \
    ...
    --icformer_path /inspire/ssd/ws-f4d69b29-e0a5-44e6-bd92-acf4de9990f0/public-project/tangbohao-240108100043/longcontext/IC-Former/output_1_8b/checkpoint-36000 \
    --output_dir /inspire/ssd/ws-f4d69b29-e0a5-44e6-bd92-acf4de9990f0/public-project/tangbohao-240108100043/bohao_mimic_project/SFT/results/try_comp \
    --bf16 True \
