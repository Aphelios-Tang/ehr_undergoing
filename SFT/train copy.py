...
from my_mimic_dataset import MIMIC_Dataset
...
@dataclass
class DataArguments:
    patient_root_dir: str = field(default="/mnt/petrelfs/wuchaoyi/my_MIMIC_IV_2.2/patients_sorted/", metadata={"help": "Path to the training data."})
    patient_id_csv: str = field(default="/mnt/petrelfs/wuchaoyi/my_MIMIC_IV_2.2/supplementary_files/split/train_patients.csv", metadata={"help": "Path to the training data."})
