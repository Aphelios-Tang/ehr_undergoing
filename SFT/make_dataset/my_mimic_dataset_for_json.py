...
if __name__ == "__main__":
    ...
    dataset = MIMIC_Dataset(patient_root_dir = "/inspire/ssd/ws-f4d69b29-e0a5-44e6-bd92-acf4de9990f0/public-project/tangbohao-240108100043/my_MIMIC_IV/patients_sorted/",patient_id_csv = "/inspire/ssd/ws-f4d69b29-e0a5-44e6-bd92-acf4de9990f0/public-project/tangbohao-240108100043/bohao_mimic_project/supplementary_files/new_split/train_mini.csv",tokenizer= tokenizer)
    def process_item(i):
        sample = dataset[i]
        return json.dumps(sample, ensure_ascii=False) + "\n"

    n_jobs = os.cpu_count() or 1  # 根据 CPU 核心数自动设置并行数
    with open("/inspire/ssd/ws-f4d69b29-e0a5-44e6-bd92-acf4de9990f0/public-project/tangbohao-240108100043/ehr_free_text/train_mini.json", "w", encoding="utf-8") as f:
        lines = Parallel(n_jobs=n_jobs)(delayed(process_item)(i) for i in tqdm.tqdm(range(len(dataset))))
        f.writelines(lines)
