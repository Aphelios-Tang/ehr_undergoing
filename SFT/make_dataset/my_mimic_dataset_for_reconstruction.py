...
if __name__ == "__main__":
    ...
    dataset = MIMIC_Dataset(patient_root_dir = "/inspire/ssd/ws-f4d69b29-e0a5-44e6-bd92-acf4de9990f0/public-project/tangbohao-240108100043/my_MIMIC_IV/patients_sorted/",patient_id_csv = "/inspire/ssd/ws-f4d69b29-e0a5-44e6-bd92-acf4de9990f0/public-project/tangbohao-240108100043/bohao_mimic_project/supplementary_files/new_split/train_mini_20.csv",tokenizer= tokenizer)

    with open("/inspire/ssd/ws-f4d69b29-e0a5-44e6-bd92-acf4de9990f0/public-project/tangbohao-240108100043/ehr_free_text/reconstruction_mini.jsonl", "w", encoding="utf-8") as f:
        for i in tqdm.tqdm(range(len(dataset))):
            sample = dataset[i]["input"]
            sample_out = create_reconstruction_data(dataset[i], tokenizer)
            for i in sample_out:
                f.write(json.dumps({"text": i}, ensure_ascii=False) + "\n")
