...
def parse_args():
    ...
    parser.add_argument('--eval_interval', type=int, default=5000, help='Evaluation interval during training')
    parser.add_argument('--eval_samples', type=int, default=5, help='Number of samples to evaluate during training')
    parser.add_argument("--number_encoder_checkpoint", type=str, default=None, help="Path to NumberEncoder checkpoint directory")
    parser.add_argument("--number_decoder_checkpoint", type=str, default=None, help="Path to NumberDecoder checkpoint directory")
