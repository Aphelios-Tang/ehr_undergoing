...
import random
from util_ehr import * # 包含数据处理的函数，xxx_item_to_free_text
import transformers
import copy
from DS import *
import torch
...
if __name__ == "__main__":
    ...
    dataset = MIMIC_Dataset(patient_root_dir = "/inspire/ssd/ws-f4d69b29-e0a5-44e6-bd92-acf4de9990f0/public-project/tangbohao-240108100043/my_MIMIC_IV/patients_sorted/",patient_id_csv = "/inspire/ssd/ws-f4d69b29-e0a5-44e6-bd92-acf4de9990f0/public-project/tangbohao-240108100043/bohao_mimic_project/supplementary_files/new_split/val.csv",tokenizer= tokenizer)
    
    # sample = dataset.get_all_hadm_ids_for_subject(12782015)
    # print(sample)
    hamd_id = dataset.get_item_by_subject_hadm(10191316, "28508275", '4')
    print("***************** input *****************")
    print(hamd_id["Input"])
    print("***************** instruction *****************")
    print(hamd_id["Instruction"])
    print("***************** output *****************")
    print(hamd_id["Output"])
