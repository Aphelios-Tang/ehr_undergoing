...
if __name__ == '__main__':
    ...
    data_dir = "/inspire/ssd/ws-f4d69b29-e0a5-44e6-bd92-acf4de9990f0/public-project/tangbohao-240108100043/longcontext/IC-Former-origin/pile.jsonl"
    data = PileDataset(data_dir)
