...
def save_item(subject_id, source, item, index, root_dir = '/inspire/ssd/ws-f4d69b29-e0a5-44e6-bd92-acf4de9990f0/public-project/tangbohao-240108100043/my_MIMIC_IV/patients/'):
...
for csv_file in csv_list:
    if (".csv" not in csv_file) or (csv_file in ["caregiver.csv","d_items.csv"]):
        continue
    else:
